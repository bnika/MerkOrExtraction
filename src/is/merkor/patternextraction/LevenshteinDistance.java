...
public class LevenshteinDistance {
    ...
    public LevenshteinDistance(String p1, String p2, int dist) {
        pattern1 = p1;
        pattern2 = p2;
        distance = dist;
    }
...
//        String t = target.toLowerCase();
    ...
    public static void main(String[] args) {
        ...
        while(threshold < 2) {
            count++;
            List<LevenshteinDistance> distList = new ArrayList<LevenshteinDistance>();
            for(int i = 0; i < patterns.size(); i++) {
                ...
                for(int j = i + 1; j < patterns.size(); j++) {
                    ...
                    LevenshteinDistance distObj = new LevenshteinDistance(source, target, dist);
...
//            }
            ...
            List<LevenshteinDistance> minList = new ArrayList<LevenshteinDistance>();
            ...
            for (LevenshteinDistance obj : minList) {
